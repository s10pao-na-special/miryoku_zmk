...
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              &rgb_ug RGB_OFF,   &rgb_ug RGB_OFF,   &rgb_ug RGB_OFF,   &rgb_ug RGB_OFF,   &rgb_ug RGB_OFF,   \
...
&kp F11,           &kp F4,            &kp F5,            &kp F6,            &u_slck_shift_nlck,U_NA,              &kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LGUI,          \
